...
class DB:
    ...
    def create(self, table_name, field1, field2, field3):
        self.cur.execute(f'CREATE TABLE IF NOT EXISTS {table_name} ({field1}, {field2}, {field3}, CONSTRAINT unique_{table_name} UNIQUE ({field1}, {field2}, {field3}))')
        return self.cur.fetchall()

    def create_guess(self, table_name, field1, field2):
        self.cur.execute(f'CREATE TABLE IF NOT EXISTS {table_name} ({field1}, {field2}, CONSTRAINT unique_{table_name} UNIQUE ({field1}, {field2}))')
        return self.cur.fetchall()
